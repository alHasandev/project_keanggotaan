...
$query = "SELECT p.nik, p.nama, p.email, p.alamat FROM pengguna p INNER JOIN mapping m ON p.nik = m.nik WHERE m.id_posisi = '1'";
...
<body>
  ...
  <div class="container">
    <h1>Daftar Admin yang Terdaftar</h1>
    <table border="1">
      <tr>
        <th>No</th>
        <th>Nama</th>
